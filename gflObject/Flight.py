...
class Flight(object):
    def __init__(self,id = 0):
		...
		self.ManifestNotes = ""
		self.DurationTaxi = datetime.timedelta()
		self.DurationBurn = datetime.timedelta()
		self.DurationCont = datetime.timedelta()
		self.DurationRes = datetime.timedelta()
		self.DurationAlt = datetime.timedelta()
		self.DurationWx = datetime.timedelta()
